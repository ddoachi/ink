...
|----|------|--------|-------------|
| [E02-F02-T01](T01/E02-F02-T01.spec.md) | Layer Assignment Algorithm | Draft | Assign cells to layers based on logic depth using longest-path algorithm |
| [E02-F02-T02](T02/E02-F02-T02.spec.md) | Crossing Minimization Algorithm | Draft | Minimize edge crossings using barycentric heuristic with bi-directional sweeps |
| [E02-F02-T03](T03/E02-F02-T03.spec.md) | Coordinate Assignment Algorithm | Draft | Convert layer/order to X/Y pixel coordinates with configurable spacing |
| [E02-F02-T04](T04/E02-F02-T04.spec.md) | LayoutEngine Protocol and Integration | Draft | Implement LayoutEngine protocol and orchestrate all three algorithm phases |

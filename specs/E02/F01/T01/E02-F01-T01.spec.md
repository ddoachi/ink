...
- [x] `CellItem` class implemented in `presentation/canvas/cell_item.py`
- [x] Renders rectangular cell symbol with rounded corners
- [x] Cell instance name displayed centered within symbol
- [x] Sequential cells visually distinct (thicker border)
- [x] Supports selection state with visual feedback
- [x] Hover state changes border color
- [x] `boundingRect()` returns correct dimensions
- [x] `paint()` method efficiently renders cell symbol
- [x] Unit tests verify rendering states and bounding calculations
- [x] Integration test shows cell rendering in QGraphicsScene

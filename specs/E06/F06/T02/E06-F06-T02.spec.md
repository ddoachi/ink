...
- [x] `save_window_geometry()` and `load_window_geometry()` methods added to `AppSettings`
- [x] `save_window_state()` and `load_window_state()` methods added to `AppSettings`
- [x] Main window calls `_restore_geometry()` on startup
- [x] Main window calls `_save_geometry()` on close
- [x] Window size persists across restarts
- [x] Window position persists across restarts
- [x] Maximized state persists across restarts
- [x] Dock widget positions persist across restarts
- [x] Dock widget sizes persist across restarts
- [x] Dock widget floating state persists across restarts
- [x] Dock widget visibility persists across restarts
- [x] First run uses default size (1280x800) and centers window
- [x] Invalid geometry data handled gracefully (falls back to defaults)
- [x] Multi-monitor scenarios handled (window stays on screen)
- [x] Settings written to disk on application close
...
- **GitHub Issue**: [Issue#10 E06-F06-T02: Window Geometry Persistence](https://github.com/ddoachi/ink/issues/10)
- **Pull Request**: [PR#11 E06-F06-T02: Window Geometry Persistence](https://github.com/ddoachi/ink/pull/11)
- **Post-Docs**: [E06-F06-T02.post-docs.md](E06-F06-T02.post-docs.md)
- **Implementation Narrative**: [E06-F06-T02-implementation-narrative.md](E06-F06-T02-implementation-narrative.md)

...
- [x] View menu contains Zoom In, Zoom Out, Fit View actions
- [x] View menu contains Hierarchy Panel, Property Panel, Message Panel toggles
- [x] Panel toggle actions show checkmarks when panels visible
- [x] Checkmarks sync automatically when panels shown/hidden via other means
- [x] Zoom actions trigger canvas zoom methods
- [x] Fit View action fits schematic to viewport
- [x] Keyboard shortcuts work: `Ctrl+=`, `Ctrl+-`, `Ctrl+0`
- [x] Help menu contains Keyboard Shortcuts and About actions
- [x] `F1` opens Keyboard Shortcuts dialog
- [x] Keyboard Shortcuts dialog shows all shortcuts in organized categories
- [x] About dialog shows app name, version, description, and credits
- [x] About dialog uses `QMessageBox.about()` with proper formatting

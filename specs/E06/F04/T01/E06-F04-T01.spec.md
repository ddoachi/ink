...
- [x] QStatusBar created and attached to main window
- [x] Status bar visible at bottom of window on launch
- [x] Four permanent widgets added to status bar
- [x] Visual separators (│) displayed between widgets
- [x] All status labels show initial placeholder text
- [x] Minimum widths configured for all widgets
- [x] Status bar maintains layout when window resized
- [x] Status bar has appropriate minimum height for readability
- [x] No runtime errors or warnings on status bar creation
- [x] Status bar follows Qt/PySide6 best practices
...
- [x] Import `QStatusBar` and `QLabel` in `main_window.py`
- [x] Implement `_setup_status_bar()` method
- [x] Implement `_create_separator()` helper method
- [x] Add instance attributes for all status labels
- [x] Call `_setup_status_bar()` in `__init__()` method
- [x] Configure minimum widths for all widgets
- [x] Add separators between widgets
- [x] Set initial placeholder text for all labels
- [x] Write unit tests for status bar setup
- [x] Verify visual appearance matches design

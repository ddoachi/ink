...
- [x] Zoom In button appears in toolbar with zoom-in icon
- [x] Zoom Out button appears in toolbar with zoom-out icon
- [x] Fit View button appears in toolbar with fit-view icon
- [x] Buttons arranged in order: Zoom Out, Zoom In, Fit View
- [x] Visual separator before and after view group
- [x] Tooltips display on hover with action name and shortcut
- [x] `Ctrl+=` triggers zoom in when pressed
- [x] `Ctrl+-` triggers zoom out when pressed
- [x] `Ctrl+0` triggers fit view when pressed
- [x] Clicking Zoom In button zooms canvas in
- [x] Clicking Zoom Out button zooms canvas out
- [x] Clicking Fit View button fits content to view
- [x] Actions work when canvas is loaded
- [x] Actions gracefully handle missing canvas (no crash)
- [x] Buttons remain enabled at all times

...
- [x] Three dock widgets created: Hierarchy, Properties, Messages
- [x] Hierarchy dock positioned on left by default
- [x] Properties dock positioned on right by default
- [x] Messages dock positioned on bottom by default
- [x] All dock widgets display placeholder content
- [x] Dock titles show correct labels

### 4.2 Dock Operations
- [x] Each dock has visible close button (X)
- [x] Clicking close button hides dock (can be restored via View menu in E06-F02)
- [x] Each dock can be undocked by dragging title bar
- [x] Undocked panels float as separate windows
- [x] Floating panels can be re-docked by dragging to allowed areas
- [x] Dock widget splitters are draggable to resize panels

### 4.3 Layout Requirements
- [x] Hierarchy panel approximately 15% of window width
- [x] Property panel approximately 25% of window width
- [x] Message panel approximately 20% of window height
- [x] Central canvas fills remaining space
- [x] No gaps between docks and central widget

### 4.4 Testing
- [x] Unit test: Each panel widget can be instantiated
- [x] Integration test: Main window creates all three docks
- [x] Integration test: Docks are positioned in correct areas
- [x] Manual test: Dock close/float/re-dock operations work
- [x] Manual test: Splitter resize works for all dock boundaries

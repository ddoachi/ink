...
- **Priority**: P0 (MVP)
- **Status**: Draft
- **PRD Sections**: §5.1 Basic Behavior, §5.2 Expansion Scope Control, §5.3 Collapse Functionality
- **Created**: 2025-12-26
...
*To be created via `/spec_work E03 --split features`*

| ID | Feature | Status |
|----|---------|--------|
| E03-F01 | Hop-Based Expansion | Draft |
| E03-F02 | Collapse Functionality | Draft |
| E03-F03 | Semantic Boundary Expansion (P1) | Draft |
| E03-F04 | Expansion State Management | Draft |

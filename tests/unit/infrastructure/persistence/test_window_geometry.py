...
class TestSaveWindowGeometry:
    ...
    def test_save_window_geometry_accepts_qbytearray(
        self, app_settings: AppSettings
    ) -> None:
    ...
    def test_save_window_geometry_persists_value(
        self, app_settings: AppSettings
    ) -> None:
...
class TestLoadWindowGeometry:
    ...
    def test_load_window_geometry_method_exists(
        self, app_settings: AppSettings
    ) -> None:
    ...
    def test_load_window_geometry_returns_saved_value(
        self, app_settings: AppSettings
    ) -> None:
    ...
    def test_load_window_geometry_returns_qbytearray_type(
        self, app_settings: AppSettings
    ) -> None:
...
class TestSaveWindowState:
    ...
    def test_save_window_state_method_exists(
        self, app_settings: AppSettings
    ) -> None:
    ...
    def test_save_window_state_accepts_qbytearray(
        self, app_settings: AppSettings
    ) -> None:
    ...
    def test_save_window_state_persists_value(
        self, app_settings: AppSettings
    ) -> None:
        ...
        # Verify value is stored under correct key
        stored = app_settings.get_value(
            AppSettings.KEY_WINDOW_STATE, value_type=QByteArray
        )
        assert stored == state
...
class TestLoadWindowState:
    ...
    def test_load_window_state_method_exists(
        self, app_settings: AppSettings
    ) -> None:
    ...
    def test_load_window_state_returns_none_when_not_saved(
        self, app_settings: AppSettings
    ) -> None:
    ...
    def test_load_window_state_returns_saved_value(
        self, app_settings: AppSettings
    ) -> None:
    ...
    def test_load_window_state_returns_qbytearray_type(
        self, app_settings: AppSettings
    ) -> None:
...
class TestHasWindowGeometry:
    ...
    def test_has_window_geometry_method_exists(
        self, app_settings: AppSettings
    ) -> None:
    ...
    def test_has_window_geometry_returns_true_after_save(
        self, app_settings: AppSettings
    ) -> None:
...
class TestHasWindowState:
    ...
    def test_has_window_state_method_exists(
        self, app_settings: AppSettings
    ) -> None:
    ...
    def test_has_window_state_returns_false_when_not_saved(
        self, app_settings: AppSettings
    ) -> None:
    ...
    def test_has_window_state_returns_true_after_save(
        self, app_settings: AppSettings
    ) -> None:
...
class TestGeometryPersistence:
    ...
    def test_window_state_persists_across_instances(
        self, isolated_settings: Path
    ) -> None:
